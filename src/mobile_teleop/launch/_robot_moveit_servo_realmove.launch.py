...
from urdf_import.moveit_configs_builder import MoveItConfigsBuilder
...
def launch_setup(context, *args, **kwargs):
    ...
    joystick_type = LaunchConfiguration('joystick_type', default=2)
    ...
    servo_yaml = load_yaml('mobile_teleop', "config/xarm_moveit_servo_config.yaml")
