...
try:
    while True:
        ...
        if c == 32:
            ...
            count = 0
            for filename in os.listdir('/home/zzt/tk23_ws/src/tk23_vision/src/'):
                if filename.endswith('.jpg'):
                    count += 1
            # print(count)

            # 保存图像，保存到上一层的imgs文件夹内，以1、2、3、4...为文件名保存图像
            cv2.imwrite('/home/zzt/tk23_ws/src/tk23_vision/src/{}.jpg'.format(count + 1), color_image)
        ...
        if c == 13:
            ...
            while flag:
                ...
                count = 0
                for filename in os.listdir('/home/zzt/tk23_ws/src/tk23_vision/src/imgs/'):
                    if filename.endswith('.jpg'):
                        count += 1
                ...
                if (time.time() - time0) > time_delay:
                    ...
                    # 保存图像，保存到上一层的imgs文件夹内，以1、2、3、4...为文件名保存图像
                    cv2.imwrite('/home/zzt/tk23_ws/src/tk23_vision/src/imgs/{}.jpg'.format(count + 1), color_image)
