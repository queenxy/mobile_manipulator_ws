...
# MOBILENETV2_BOTTLENECK_WTS = os.path.join(dirname, "weights/mobilenetv2_bottleneck_wts.pt")
...
# TORCHREID_OSNET_AIN_X1_0_MS_D_C_WTS = os.path.join(dirname, "weights/osnet_ain_ms_d_c_wtsonly.pth")
