...
class MoveItConfigsBuilder(ParameterBuilder):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.__urdf_package = Path(get_package_share_directory('mobile_bringup'))
        self.__srdf_package = Path(get_package_share_directory('mobile_bringup'))
        self.__urdf_file_path = Path('urdf/mobile_manipulator.urdf.xacro')
    ...
    def robot_description_semantic(
        ...
        file_path = self.__srdf_package / (file_path or self.__srdf_file_path)
    ...
    def joint_limits(self, file_path = None):
        ...
        if all(isinstance(value, str) for value in params):
            ...
            if file_path is None:
                file_path = self.__urdf_package / 'config' / robot_name / 'joint_limits.yaml'
